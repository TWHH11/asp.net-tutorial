...
namespace MovieList.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        public OfficeAssignmentsController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        {
            var mvcMovieContext = _context.OfficeAssignments.Include(o => o.Instructor);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcMovieContext.OfficeAssignments'  is null.");
            }
            var officeAssignment = await _context.OfficeAssignments.FindAsync(id);
            if (officeAssignment != null)
            {
