...
namespace MovieList.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        {
            var mvcMovieContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcMovieContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
