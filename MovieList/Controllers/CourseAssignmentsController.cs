...
namespace MovieList.Controllers
{
    public class CourseAssignmentsController : Controller
    {
        ...
        public CourseAssignmentsController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        {
            var mvcMovieContext = _context.CourseAssignments.Include(c => c.Course).Include(c => c.Instructor);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcMovieContext.CourseAssignments'  is null.");
            }
            var courseAssignment = await _context.CourseAssignments.FindAsync(id);
            if (courseAssignment != null)
            {
